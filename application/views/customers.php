                ...
                <div class="modal-body">
                    <form id="update_form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input class="form-control" type="number" value="987-654-3210" placeholder="Your Number" id="edit_number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                ...
                success: function(data) {
                    ...
                    for (let i = 0; i < customer.length; i++) {
                        ...
                        str += `<tr>
                                ...
                                <input type="checkbox"  ${customer_status} onclick="status(this,'${customer[i].uid}')">
                                ...
                                <button class="hdrbtn mx-2 delete_customers" data-toggle="modal" data="${customer[i].uid}" data-target="#deltmodl" >
