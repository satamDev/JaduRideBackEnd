        ...
        success: function(data) {
          ...
          for (let i = 0; i < admin.length; i++) {
            ...
            str += `<tr>
                        ...
                        <button class="hdrbtn mx-2 edit_user" data-toggle="modal" id=" editbtn"  data-target="#edtView1"  onclick="edit_admin('${admin[i].uid}' , '${admin[i].name}' , '${admin[i].email}' , '${admin[i].mobile}')">
                        ...
                        <button class="hdrbtn mx-2 delete_admin" data-toggle="modal" data="${admin[i].uid}" data-target="#deltmodl" >
