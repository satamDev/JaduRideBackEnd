...
class Franchise_model extends CI_Model
{
    ...
    public function get_franchise_details()
    {
        ...
        // $this->db->where('users.type_id', 'user_franchise');
    ...
    public function update_franchise_details($uid, $name, $email, $mobile)
    {
        $uid_exist = $this->userid_exists($uid, field_uid, table_users);
        if ($uid_exist) {
            $data = [
    ...
    public function add_franchise_details($uid, $name, $email, $mobile, $user_type_id, $password)
    {
        $uid_exist = $this->userid_exists($uid, field_uid, table_users);
        if (!$uid_exist) {
            $data = [
            ...
            if ($insert) {
                ...
                $this->db->insert(table_franchise, $franchise_data);
